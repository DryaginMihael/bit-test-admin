...
function NavBar() {
  return <nav className="NavBar bg-blue-gray mx-3 sm:mx-6 my-6 p-4 flex justify-between items-center rounded-lg h-[86px]">
    <div className="text-white font-bold text-lg">BitTest</div>
    ...
    <div className="text-white border-2 border-gray-800 rounded-md items-center p-2 hidden sm:flex h-[60px]">
      <div className="bg-slate-600 p-2 mx-1 rounded-full">
        <FontAwesomeIcon icon={faUser} className="w-[25px]" />
      </div>
      <div className="ml-2">
        <p className="text-gray-500">Вы авторизованы</p>
